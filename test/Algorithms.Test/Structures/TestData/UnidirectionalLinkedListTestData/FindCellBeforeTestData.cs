...
{
    public class FindCellBeforeTestData : IEnumerable<object[]>
    {
        ...
        {
            {
                ...
                var expectedCell = new UnidirectionalLinkedListInfo.CellInfo(false, true, null, true);
                var expectedNextCell = new UnidirectionalLinkedListInfo.CellInfo(false, false, "A", false);
